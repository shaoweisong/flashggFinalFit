...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/makeYields.py --cat RECO_untagged_1jet --procs auto --ext M2000_1jet --mass 125 --inputWSDirMap 2017=/eos/user/s/shsong/hhwwgg_root/hhwwgg_root_FH/ws_gghh_M2000_1jet --sigModelWSDir /eos/user/s/shsong/hhwwgg_root/hhwwgg_root_FH/ws_gghh_M2000_1jet --sigModelExt packaged --bkgModelWSDir /eos/user/s/shsong/hhwwgg_root/hhwwgg_root_FH/ws_1jet --bkgModelExt multipdf 
