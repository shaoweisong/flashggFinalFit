...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/makeYields.py --cat RECO_untagged_2jets_3jets --procs auto --ext M1000_2jets_3jets --mass 125 --inputWSDirMap 2017=/eos/user/s/shsong/hhwwgg_root/hhwwgg_root_FH/ws_gghh_M1000_2jets_3jets --sigModelWSDir /eos/user/s/shsong/hhwwgg_root/hhwwgg_root_FH/ws_gghh_M1000_2jets_3jets --sigModelExt packaged --bkgModelWSDir /eos/user/s/shsong/hhwwgg_root/hhwwgg_root_FH/ws_2jets_3jets --bkgModelExt multipdf 
