...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Signal/scripts/packageSignal.py --cat RECO_untagged_2jets_SL_unpassed100cut --outputExt packaged_M2600_2jets_unpassed100cut_SL --massPoints 125 --exts dcb_2017_M2600_2jets_unpassed100cut_SL, --year 2017
