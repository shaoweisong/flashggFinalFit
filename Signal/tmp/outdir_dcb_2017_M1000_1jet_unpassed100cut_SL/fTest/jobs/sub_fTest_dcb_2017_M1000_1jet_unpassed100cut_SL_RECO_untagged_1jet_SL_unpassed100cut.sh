...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Signal/scripts/fTest.py --cat RECO_untagged_1jet_SL_unpassed100cut --procs gghh --ext dcb_2017_M1000_1jet_unpassed100cut_SL --inputWSDir /eos/user/s/shsong/hhwwggSL_root/SL/ws_gghh/ws_gghh_M1000_1jet_unpassed100cut 
