...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Signal/scripts/signalFit.py --inputWSDir /eos/user/s/shsong/hhwwggSL_root/SL/ws_gghh/ws_gghh_M300_2jets_unpassed100cut --ext dcb_2017_M300_2jets_unpassed100cut_SL --proc gghh --cat RECO_untagged_2jets_SL_unpassed100cut --year 2017 --analysis STXS --massPoints 125 --scales '' --scalesCorr '' --scalesGlobal '' --smears '' --skipSystematics
