...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Signal/scripts/packageSignal.py --cat RECO_untagged_1jet_SL_passed100cut --outputExt packaged_M3000_1jet_passed100cut_SL --massPoints 125 --exts dcb_2017_M3000_1jet_passed100cut_SL, --year 2017
