...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Signal/scripts/fTest.py --cat RECO_untagged_2jets_SL_unpassed100cut --procs gghh --ext dcb_2017_M700_2jets_unpassed100cut_SL --inputWSDir /eos/user/s/shsong/hhwwggSL_root/SL/ws_gghh/ws_gghh_M700_2jets_unpassed100cut 
