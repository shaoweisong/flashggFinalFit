...
python /afs/cern.ch/user/s/shsong/CMSSW_10_6_20/src/flashggFinalFit/Datacard/makeYields.py --cat RECO_untagged_4jets --procs auto --ext M2600_4jets --mass 125 --inputWSDirMap 2017=/eos/user/s/shsong/hhwwgg_root/hhwwgg_root_FH/ws_gghh_M2600_4jets --sigModelWSDir /eos/user/s/shsong/hhwwgg_root/hhwwgg_root_FH/ws_gghh_M2600_4jets --sigModelExt packaged --bkgModelWSDir /eos/user/s/shsong/hhwwgg_root/hhwwgg_root_FH/ws_4jets --bkgModelExt multipdf 
